...
class ViewController: UIViewController {
    ...
    var apiServiceForAlamofire = AlamoFireApiService()
    ...
    @IBAction func alamofirePostBtnClicked(_ sender: Any) {
        ...
        apiServiceForAlamofire.postRequest()

    }
    
    @IBAction func alamofireDeleteBtnClicked(_ sender: Any) {
        // TODO: Call HTTP Delete function on AlamoFireApiService instance
        apiServiceForAlamofire.deleteRequest()
    }
