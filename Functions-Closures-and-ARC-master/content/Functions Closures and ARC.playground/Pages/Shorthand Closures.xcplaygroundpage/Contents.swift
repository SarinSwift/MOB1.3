...
// we're checking the statement behind the '?'
// If it's true, we run '$0 + $1' (before the semicolon)
// If it's not, we run '$0' (after the semicolon)
let geniusReduce = numbersToSumm.reduce(0) { $1 >= 0 ? $0 + $1 : $0 }
print(geniusReduce)
/*:
