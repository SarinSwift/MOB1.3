...
class ItemContactInfoViewController: UIViewController {
    ...
    @IBAction func pressSave(_ sender: UIButton) {
        ...
        // DIDDO: added the data to database in firebase
        
        // Getting the reference to the database
        var ref: DatabaseReference!
        ref = Database.database().reference()
        
        // Getting an autogenerated ID,
    ...
    // DIDDO: this function adds the image to Firebase storage
    //      Contains a single folder called "items" and each image will have the key/id as the file name
