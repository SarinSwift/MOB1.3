...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    private let APIKey = "73642ad27092a0df33f1d4688ec41004"
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell,
        ...
        // starting the animation until image is uploaded
        ...
        self.fetchImage(for: photo, completion: { (result) -> Void in
            ...
            if let cell = self.collectionView.cellForItem(at: photoIndexPath)
                ...
                // stopping the animation once the picture is uploaded onto the cell
    ...
    // escaping - this closure will execute after the function is complete. Mainly after reloadData() finishes.
    ...
    private func urlBuilder(parameters: [String:String]?) -> URL {
        ...
        // appending all the items into the query
        var queryItems = [URLQueryItem]()
        
        // names we gave the items
        let baseParams = [
            "method": flickrMethod,
            "format": "json",
            "nojsoncallback": "1",
    ...
    // creating the photo item from json data
